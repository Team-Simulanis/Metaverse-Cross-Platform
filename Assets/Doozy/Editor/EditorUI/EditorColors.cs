    ...
    public static class EditorColors
    {
        ...
        public static class Help
        {
            ...
            private static EditorDataColorPalette colorPalette =>
                s_colorPalette != null
                    ? s_colorPalette
                    : s_colorPalette = EditorDataColorDatabase.GetColorPalette("Help");
            ...
            private static Color? s_ErrorBackground;
            public static Color ErrorBackground => (Color) (s_ErrorBackground ?? (s_ErrorBackground = GetColor(ColorName.ErrorBackground)));
            private static Color? s_ErrorText;
            public static Color ErrorText => (Color) (s_ErrorText ?? (s_ErrorText = GetColor(ColorName.ErrorText)));
            private static Color? s_InfoBackground;
            public static Color InfoBackground => (Color) (s_InfoBackground ?? (s_InfoBackground = GetColor(ColorName.InfoBackground)));
            private static Color? s_InfoText;
            public static Color InfoText => (Color) (s_InfoText ?? (s_InfoText = GetColor(ColorName.InfoText)));
            private static Color? s_WarningBackground;
            public static Color WarningBackground => (Color) (s_WarningBackground ?? (s_WarningBackground = GetColor(ColorName.WarningBackground)));
            private static Color? s_WarningText;
            public static Color WarningText => (Color) (s_WarningText ?? (s_WarningText = GetColor(ColorName.WarningText)));
