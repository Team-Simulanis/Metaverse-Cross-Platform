    ...
    public static class EditorSelectableColors
    {
        ...
        public static class Help
        {
            ...
            private static EditorDataSelectableColorPalette selectableColorPalette =>
                s_selectableColorPalette != null
                    ? s_selectableColorPalette
                    : s_selectableColorPalette = EditorDataSelectableColorDatabase.GetSelectableColorPalette("Help");
            ...
            private static EditorSelectableColorInfo s_ErrorBackground;
            public static EditorSelectableColorInfo ErrorBackground => s_ErrorBackground ?? (s_ErrorBackground = GetSelectableColorInfo(ColorName.ErrorBackground));
            private static EditorSelectableColorInfo s_ErrorText;
            public static EditorSelectableColorInfo ErrorText => s_ErrorText ?? (s_ErrorText = GetSelectableColorInfo(ColorName.ErrorText));
            private static EditorSelectableColorInfo s_InfoBackground;
            public static EditorSelectableColorInfo InfoBackground => s_InfoBackground ?? (s_InfoBackground = GetSelectableColorInfo(ColorName.InfoBackground));
            private static EditorSelectableColorInfo s_InfoText;
            public static EditorSelectableColorInfo InfoText => s_InfoText ?? (s_InfoText = GetSelectableColorInfo(ColorName.InfoText));
            private static EditorSelectableColorInfo s_WarningBackground;
            public static EditorSelectableColorInfo WarningBackground => s_WarningBackground ?? (s_WarningBackground = GetSelectableColorInfo(ColorName.WarningBackground));
            private static EditorSelectableColorInfo s_WarningText;
            public static EditorSelectableColorInfo WarningText => s_WarningText ?? (s_WarningText = GetSelectableColorInfo(ColorName.WarningText));
