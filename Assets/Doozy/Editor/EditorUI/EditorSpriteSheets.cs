    ...
    public static class EditorSpriteSheets
    {
        public static class EditorUI
        {
            ...
            public static class Icons
            {
                ...
                public static List<Texture2D> Pitch => GetTextures(SpriteSheetName.Pitch);
                ...
                public static List<Texture2D> Random => GetTextures(SpriteSheetName.Random);
                ...
                public static List<Texture2D> Sequence => GetTextures(SpriteSheetName.Sequence);
                ...
                public static List<Texture2D> ThreeD => GetTextures(SpriteSheetName.ThreeD);
                ...
                public static List<Texture2D> TwoD => GetTextures(SpriteSheetName.TwoD);
